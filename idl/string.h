...
public:
     ...
     * @param x Reference to the object String that will be copied.
     */
    eProsima_user_DllExport String(String &&x);
     ...
     * @param x Reference to the object String that will be copied.
     */
    eProsima_user_DllExport String& operator=(String &&x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const String& data, size_t current_alignment = 0);
